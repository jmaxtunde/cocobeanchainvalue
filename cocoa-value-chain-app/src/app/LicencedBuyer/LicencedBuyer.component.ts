...
@Component({
  selector: 'app-licencedbuyer',
  templateUrl: './LicencedBuyer.component.html',
  styleUrls: ['./LicencedBuyer.component.css'],
  providers: [LicencedBuyerService]
})
export class LicencedBuyerComponent implements OnInit {
  ...
  constructor(public serviceLicencedBuyer: LicencedBuyerService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceLicencedBuyer.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.cocoanetwork.LicencedBuyer',
    ...
    return this.serviceLicencedBuyer.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceLicencedBuyer.updateParticipant(form.get('cocoaParticipantId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceLicencedBuyer.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceLicencedBuyer.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
