...
@Component({
  selector: 'app-selltoconsumer',
  templateUrl: './SellToConsumer.component.html',
  styleUrls: ['./SellToConsumer.component.css'],
  providers: [SellToConsumerService]
})
export class SellToConsumerComponent implements OnInit {
  ...
  constructor(private serviceSellToConsumer: SellToConsumerService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceSellToConsumer.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.cocoanetwork.SellToConsumer',
    ...
    return this.serviceSellToConsumer.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceSellToConsumer.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceSellToConsumer.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceSellToConsumer.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
