...
@Component({
  selector: 'app-localbuyer',
  templateUrl: './LocalBuyer.component.html',
  styleUrls: ['./LocalBuyer.component.css'],
  providers: [LocalBuyerService]
})
export class LocalBuyerComponent implements OnInit {
  ...
  constructor(public serviceLocalBuyer: LocalBuyerService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceLocalBuyer.getAll()
    .toPromise()
    .then((result) => {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.cocoanetwork.LocalBuyer',
    ...
    return this.serviceLocalBuyer.addParticipant(this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceLocalBuyer.updateParticipant(form.get('cocoaParticipantId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  deleteParticipant(): Promise<any> {
    ...
    return this.serviceLocalBuyer.deleteParticipant(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceLocalBuyer.getparticipant(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
